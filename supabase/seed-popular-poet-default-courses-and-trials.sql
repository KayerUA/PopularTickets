...
values
  (
    'improv',
    'Импровизация',
    'Импровизация — это занятия, где человек учится быть свободнее, быстрее реагировать, легче общаться и не бояться проявляться. Это формат про игру, живой контакт, смех, раскрепощение и ощущение, что можно быть собой здесь и сейчас.',
    '/courses/impro.jpg',
    '/courses/impro.jpg',
    'improv',
    'Импро',
  ...
  (
    ...
    'Актёрское мастерство — это работа с голосом, телом, вниманием и подачей, которая помогает человеку увереннее чувствовать себя и на сцене, и в жизни. На занятиях участники развивают свободу самовыражения и умение быть в контакте с собой и другими.',
    '/courses/akterka.jpg',
    '/courses/akterka.jpg',
    'acting',
    'Актёрское',
