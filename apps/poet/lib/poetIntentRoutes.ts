...
const RU: PoetIntentPage[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Да. Если формат подходит, можно присоединиться к регулярной актёрской или импровизационной группе.",
      },
    ],
  },
  {
    ...
    description:
      "PLAY-BACK театр в Варшаве: актёры воспроизводят истории зрителей наживо. Занятия и события Popular Poet.",
  ...
  },
  {
    ...
    description:
      "Актёрские курсы и импровизация для начинающих в Варшаве: старт с основ, малые группы, сценическая практика Popular Poet.",
    ...
    bullets: [
      ...
      "актёрство, импровизация и PLAY-BACK",
    ...
    faq: [
      {
        q: "С чего лучше начать — актёрство или импровизация?",
        a: "Оба формата дружелюбны к новичкам. Импровизация даёт быструю игру в группе, актёрский курс — более широкую работу с текстом и эмоцией.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Куда пойти одному в Варшаве: камерные шоу, импровизация и встречи Popular Poet — пространство, где легко быть собой и познакомиться с людьми.",
    ...
    bullets: [
      ...
      "импровизационные шоу и спектакли вечером",
